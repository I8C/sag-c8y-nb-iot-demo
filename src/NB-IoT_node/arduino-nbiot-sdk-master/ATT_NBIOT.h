...
class ATT_NBIOT: public Sodaq_AT_Device
{
  public:
    ATT_NBIOT();
    ATT_NBIOT(const char* deviceToken);
    ATT_NBIOT(const char* deviceToken, const char* apn);
    ...
    void setAttDevice(const char* deviceToken, const char* apn);
    ...
    bool connect(const char* udp, const char* port);
